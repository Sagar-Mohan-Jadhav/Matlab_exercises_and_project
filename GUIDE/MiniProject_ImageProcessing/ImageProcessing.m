...
% Last Modified by GUIDE v2.5 10-Nov-2022 23:21:17
...
global image
global change
slidervalue = get(handles.brightness, 'value');
brightimage = slidervalue * 2 * image;
axes(handles.axes1)
imshow(brightimage)
change = brightimage - image;
